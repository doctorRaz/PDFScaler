namespace drz.PDFScaler.Servise
{
    internal static class MessagWelcom
    {
        ...
        public static string[] Welcom = new string[] {
            ...
            "\t\tТаким образом внешние ссылки PDF будут масштабироваться одинаково в AutoCAD и nanoCAD",
            "\t\tПосле обработки будут созданы резервные копии существующих файлов *.BAK",
            "\t\tВы используете программу на свой страх и риск!",
             "\t\tОбрабатываемые файлы не должны бить открыткрыты в просмотрщике",
            "\t\tи не загружены в чертеж, как внешние ссылки",
            "",
